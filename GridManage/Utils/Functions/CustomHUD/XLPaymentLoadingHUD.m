...
-(void)buildUI{
    ...
    _animationLayer.strokeColor = SYSTEM_COLOR.CGColor;
    _animationLayer.lineWidth = loading_lineWidth;
...
-(void)updateAnimationLayer{
    ...
    CGFloat radius = _animationLayer.bounds.size.width/2.0f - loading_lineWidth/2.0f;
